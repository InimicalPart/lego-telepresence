...
export default function MovementControls({carId}:{carId: string}) {
    ...
    useEffect(() => {
        ...
        function onFreeControlUpdate(data: any) {
            setFreeControl(data.detail.value)
        }

        window.addEventListener("LTP-KeyboardControlUpdate", onKeyboardControlUpdate)
        window.addEventListener("LTP-FreeControlUpdate", onFreeControlUpdate)

        function onKeyInput(data: any) {
        ...
        return () => {
            ...
            window.removeEventListener("LTP-FreeControlUpdate", onFreeControlUpdate)
